...
u = c.users.create!(name: 'nick', email: 'n@n.com', password: 'pw', password_confirmation: 'pw', street: "Chemin du Pommier 14", city: "Geneva", state: "Geneva", country: "Switzerland")
